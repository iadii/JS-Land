...
// if purple is already exist in class then it will remove 
// if ig doesn't then it will add
// if it removes then it will remove false
// it it adds then it will return true
